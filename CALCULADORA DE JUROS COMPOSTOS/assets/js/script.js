...
document.getElementById("tempo").innerHTML = "O valor inicial de R$  " + value + " é aplicado a uma taxa de " + fee + "%, gerando um montante de R$ "+ valorfinal+ ""+ ", ao final de um período de: " + "<br>"+"<b>"+ anos  +" ano(os), " + meses + " mes(es) e " + dias + "  dia(s)." +"<b>";
